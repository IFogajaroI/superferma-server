...
LOG = Path("superferma_v42_grass_timer_test.log")
PRINT_LIMIT = 65535
    ...
    try:
        while True:
            ...
            if action == 202:
                ...
                send_normal_response(conn, mow_payload, "Action202 Mow Response + 00 envelope")
                log("*** ACTION 202 -> Response(result=1) SENT (mow test) ***")
                continue
...
def tcp_server():
    ...
    s.listen(30)
    log("TCP v42-grass-timer-test listening on 127.0.0.1:8866")
...
def http_server():
    ...
    log("HTTP v42-grass-timer-test listening on 127.0.0.1:8080")
    srv.serve_forever()

if __name__ == "__main__":
    print("Superferma local server v42-grass-timer-test")
    print("----------------------------------------------")
    print("IMPORTANT:")
    ...
    print("  ACTION 202 -> Response(result=1) [mow test]")
    ...
    print("Send superferma_v42_grass_timer_test.log + screenshot if anything changes.")
    print("")
